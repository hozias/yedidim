        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    var duplicatedUserName = _db.GetCollection<User>("Users").FindOne(Query<User>.Where(s => s.Email == model.Email));
                    ...
                    {
                        ModelState.AddModelError("","User already exists, try again");
                    }
                }
